...
export default function CategoryTabs({
  ...
  return (
    <div className={`flex flex-nowrap overflow-x-auto items-center gap-2 sm:gap-3 w-full px-2 pb-3 -mb-3 snap-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none ${className || 'justify-center'}`}>
      {categories.map((cat) => (
        <button
          key={cat.id}

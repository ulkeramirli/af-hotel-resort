            ...
            {user ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 p-2 sm:px-3 sm:py-2 bg-white border border-stone-200 rounded-xl hover:bg-stone-50 transition-all duration-300 cursor-pointer"
                >
              ...
              <Link
                href="/auth/sign-in"
                className="flex items-center space-x-2 p-2 sm:px-3 sm:py-2 bg-white border border-stone-200 hover:border-stone-400 hover:bg-stone-50 text-slate-700 rounded-xl transition-all duration-300 cursor-pointer"
              >

            ...
            {user ? (
              <>
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-8 h-8 sm:w-auto sm:h-auto sm:px-3 sm:py-2 text-slate-700 bg-white border border-stone-200 hover:border-stone-300 hover:bg-stone-50 rounded-xl transition-all duration-300 cursor-pointer"
                >

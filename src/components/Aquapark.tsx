        ...
        <div className="flex flex-col items-center justify-center relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#1e325c] tracking-wide font-serif leading-tight wrap-break-word whitespace-normal text-center max-w-3xl">
              <TextReveal key={displayTitle} text={displayTitle} delay={0.1} center />
            </h2>
            <motion.div
              ...
              className="text-sm md:text-base font-medium text-stone-500 prose prose-sm prose-stone max-w-2xl text-center [&>p]:mb-0 mx-auto px-4 w-full wrap-break-word whitespace-normal [&>p]:wrap-break-word [&>p]:whitespace-normal" dangerouslySetInnerHTML={{ __html: displaySubtitle.replace(/&nbsp;/g, ' ') }}
            />
          </motion.div>
        </div>
                  ...
                  >
                    ...
                    <div className="p-5 md:p-6 grow flex flex-col justify-between space-y-3 relative z-20">
                      <div>
                        ...
                        <div 
                          className="text-[11px] md:text-xs text-stone-500 font-medium leading-relaxed wrap-break-word whitespace-normal [&>p]:mb-1 [&>p]:line-clamp-3 line-clamp-3 [&>p]:wrap-break-word [&>p]:whitespace-normal" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 pt-4">
          ...
          <div className="bg-white border border-stone-100 rounded-4xl p-6 md:p-8 relative overflow-hidden group shadow-sm flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-3 relative z-10 flex-1">
              {(tickets.length > 0 ? tickets.map((t) => ({ label: loc(t.name), price: getPriceDisplay(t.price), _id: t._id })) : [

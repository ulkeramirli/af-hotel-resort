    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f4f7f6; padding: 40px 0; margin: 0;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          <tr>
            <td align="center" style="background: linear-gradient(135deg, #ef4444, #991b1b); padding: 40px 20px;">
              <div style="background-color: rgba(255,255,255,0.2); width: 60px; height: 60px; border-radius: 50%; display: inline-block; margin-bottom: 15px; line-height: 60px; font-size: 30px;">⚠️</div>
              <h1 style="color: #ffffff; margin: 0; font-size: 28px; letter-spacing: 2px;">AF HOTEL & RESORT</h1>
              <p style="color: #fee2e2; margin: 10px 0 0; font-size: 14px; font-weight: 300; letter-spacing: 1px;">REZERVASIYA LƏĞV EDİLDİ</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
                Təəssüf ki, sizin rezervasiya sorğunuz <b>ləğv edildi</b>. Hər hansı bir ödəniş etmisinizsə, yaxın vaxtlarda geri qaytarılacaqdır.
              </p>
              
              <div style="background-color: #f8fafc; border-left: 4px solid #ef4444; padding: 25px; border-radius: 0 8px 8px 0; margin-bottom: 30px;">
              ...
              <p style="color: #4b5563; font-size: 15px; line-height: 1.6;">
                Əlavə məlumat və ya yeni rezervasiya üçün bizimlə əlaqə saxlaya bilərsiniz. Gələcəkdə sizi qonaq qismində görməyə şad olarıq.
              </p>
            </td>
          </tr>
          <tr>

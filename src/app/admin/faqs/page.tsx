              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-sm text-[#1e325c] mb-1 truncate">{typeof faq.question === 'object' ? ((faq.question as any)?.az || "") : faq.question}</h4>
                    <div 
                      className="text-xs text-stone-500 line-clamp-3 break-words [&>p]:m-0 [&>p]:break-words [&>p]:whitespace-normal"
                      dangerouslySetInnerHTML={{ __html: typeof faq.answer === 'object' ? ((faq.answer as any)?.az || "") : faq.answer }}
                    />
                  </div>
                </div>

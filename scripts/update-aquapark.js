...
async function run() {
  ...
  try {
    ...
    const acts = [
      ...
      { category: idAqua, title: { az: "VIP hovuz", en: "VIP pool", ru: "VIP бассейн" }, description: { az: "Sakitlik və rahatlıq axtaranlar üçün xüsusi hovuz", en: "Special pool for those seeking peace and comfort", ru: "Специальный бассейн для ищущих покой и комфорт" }, image: "/pools/vip_pool.png" },

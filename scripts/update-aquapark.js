...
async function run() {
  ...
  try {
    ...
    const acts = [
      // Aqua
      { category: idAqua, title: { az: "AF Beach & Akvapark", en: "AF Beach & Aquapark", ru: "AF Beach & Аквапарк" }, description: { az: "Ekstremal sürüşmələr və böyük hovuz", en: "Extreme slides and a large pool", ru: "Экстремальные горки и большой бассейн" }, image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600&q=80" },
      { category: idAqua, title: { az: "Böyüklər üçün VIP Hovuz", en: "VIP Pool for Adults", ru: "VIP-бассейн для взрослых" }, description: { az: "Sakit istirahət üçün xüsusi zona", en: "Special zone for quiet relaxation", ru: "Специальная зона для спокойного отдыха" }, image: "https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=600&q=80" },
      { category: idAqua, title: { az: "Uşaq VIP Hovuzu", en: "Kids VIP Pool", ru: "Детский VIP-бассейн" }, description: { az: "Balacalar üçün təhlükəsiz və əyləncəli hovuz", en: "Safe and fun pool for the little ones", ru: "Безопасный и веселый бассейн для малышей" }, image: "https://images.unsplash.com/photo-1576610616656-d3aa5d1f4534?w=600&q=80" },
